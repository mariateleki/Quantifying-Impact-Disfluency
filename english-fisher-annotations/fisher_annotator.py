    ...
    def parse_sentences(self):
        ...
        for file in transcript_files_list:
            ...
            try:
                ...
                new_filename = os.path.join(output_dir, file.replace(".txt", "") + "_orig_dys.txt")
                with open(new_filename, "w") as output_file:
                    output_file.write("\n".join(df_labels))
                    
                new_text = utils_trees.get_intj_prn_edited_transcript_from_tree_file(filepath=parse_filename)
